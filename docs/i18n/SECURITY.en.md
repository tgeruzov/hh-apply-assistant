...
A broken selector, an unconfirmed application, or a UI regression without security impact belongs in the [English bug report form](https://github.com/tgeruzov/hh-apply-assistant/issues/new?template=bug_report_en.yml).
