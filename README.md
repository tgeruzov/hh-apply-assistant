...
Когда вы откликнулись, вакансия сама пропадает из очереди: скрипт видит подтверждение на её странице, в том числе если вы ответили на вопросы в окне без перезагрузки страницы. Такой отклик прибавляется к счётчику за сегодня, потому что hh.ru тоже учитывает его в суточном лимите. Если скрипт подтверждение не заметил, нажмите галочку в строке вакансии: она уберёт вакансию и засчитает отклик. Крестик убирает вакансию без счёта, а `Очистить всё` просит подтверждения. Очередь и счётчик общие для всех вкладок hh.ru и обновляются в них без перезагрузки.

<p align="center">
  <img src="docs/images/panel-queue.png" width="430" alt="Вкладка Очередь: вакансии для ручного отклика с причиной, зарплатой, галочкой и крестиком">
</p>
